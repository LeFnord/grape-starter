...
RSpec.describe Api::Rake::Names do
  ...
  describe 'plural forms' do
    describe 'foos' do
      ...
      specify { expect(subject.base_file_name).to eql 'foos' }
    end
    ...
    describe 'foo_bars' do
      ...
      specify { expect(subject.base_file_name).to eql 'foo_bars' }
    end
    ...
    describe 'foo-bars' do
      ...
      specify { expect(subject.base_file_name).to eql 'foo-bars' }
    end
  ...
  describe 'singular forms' do
    describe 'foo' do
      ...
      specify { expect(subject.base_file_name).to eql 'foo' }
    end
    ...
    describe 'foo_bar' do
      ...
      specify { expect(subject.base_file_name).to eql 'foo_bar' }
    end
    ...
    describe 'foo-bar' do
      ...
      specify { expect(subject.base_file_name).to eql 'foo-bar' }
    end
